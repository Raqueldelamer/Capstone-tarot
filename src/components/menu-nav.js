...
export default function MenuNav(props) {
    ...
    <div className=" text-yellow-500 text-center font-sans text-xl space-x-6 flex justify-end">
        <div><Link href="/index" className='hover:text-yellow-200'>{menuItems[0]}</Link></div>
